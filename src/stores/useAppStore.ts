...
export const useAppStore = create<AppState>((set) => ({
  ...
  assistantMessages: [
    {
      role: "assistant",
      text: "Ողջույն! Ես CAPSULE PACK-ի փաթեթավորման և տպագրության պաշտոնական AI օգնականն եմ։ Կարող եմ Ձեզ խորհրդատվություն տալ տոպրակների, տուփերի, սթիքերների, այցեքարտերի կամ ժապավենների նյութերի, լամինացիայի, չափսերի և տպագրական տեխնիկաների վերաբերյալ։ Ինչպե՞ս կարող եմ օգնել։",
    },
  ],
  assistantInput: "",
